---
layout: post
title: "실시간 대용량 데이터 파이프라인 구축 : V2X 프로젝트"
excerpt: "실시간 대용량 데이터를 처리하는 파이프라인을 구축한 프로젝트입니다. Airflow, Kafka, Spark, Hadoop을 활용하여 데이터 레이크 기반 분석 환경을 제공합니다."
permalink: /projects/v2x
date: 2024-08-06
last_modified_at: 2024-10-15
categories: [Project]
tags: [development, v2x, spark, kafka, airflow, hadoop]
featured: true
show_date: true
comments: true
share: true
