...
excerpt: "YouTube API를 활용한 플레이리스트 추천 서비스입니다. LSTM 모델과 MLOps 파이프라인을 구축하여 키워드만으로 플레이리스트를 추천합니다."
permalink: /projects/plytube
date: 2024-09-19
last_modified_at: 2024-10-15
categories: [Project]
tags: [development, plytube, lstm, youtube-api, airflow, mlflow]
featured: true
show_date: true
comments: true
share: true
image: /assets/images/project_img/yeardream/plytube_architecture.png
---
