...
excerpt: "타이어 결함 검출을 위한 이미지 분류 모델과 MLOps 파이프라인을 구축한 프로젝트입니다. 자동화된 모델 학습과 배포 시스템을 구현했습니다."
date: 2024-10-15
categories: [Project]
tags: [development, flatfix, mlops, image-classification, spark, kafka, machine-learning, data-pipeline]
image: /assets/images/project_img/yeardream/flatfix_architecture.png
---
